...
export const translations = {
  en: {
    ...
    resources: {
      ...
      videoPortfolio: {
        ...
        items: [
            { id: "5HDE_DKfV2o", title: "Patient Review 1" },
            { id: "Tww1sKUnze8", title: "Patient Review 2" },
            { id: "EzxyVtuxLtU", title: "Patient Review 3" },
            { id: "Ps57-7Fq0bU", title: "Patient Review 4" },
            { id: "NqSnMhxkcQ8", title: "Patient Review 5" },
            { id: "KL0xhR7oV5w", title: "Patient Review 6" },
            { id: "hfYgwgLTZ1w", title: "Patient Review 7" },
            { id: "N6wB5FTDb54", title: "Patient Review 8" },
            { id: "AM6PekaR02w", title: "Patient Review 9" },
            { id: "J17R1Z8QGYw", title: "Patient Review 10" },
            { id: "L02CGmgCLSA", title: "Patient Review 11" }
        ]
      },
      cta: {
  ...
  bn: {
    ...
    footer: {
      ...
      copyright: `© ${new Date().getFullYear()} ড. এরফান কোলোরেক্টাল সেন্টার। সর্বস্বত্ব সংরক্ষিত।`,
    },
    home: {
      hero: {
        title: "ড. এরফান কোলোরেক্টাল সেন্টার",
    ...
    about: {
      ...
      subtitle: "ড. এরফান কোলোরেক্টাল সেন্টারের প্রতিষ্ঠাতা",
      section1: {
      ...
      milestones: {
        ...
        items: [
          ...
          { year: "২০১৮", event: "ড. এরফান কোলোরেক্টাল সেন্টার প্রতিষ্ঠা" },
    ...
    services: {
      ...
      contact: {
        ...
        info: {
          ...
          addressTitle: "ড. এরফান কোলোরেক্টাল সেন্টার",
