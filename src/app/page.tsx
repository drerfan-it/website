...
import { CheckCircle, HeartPulse, ShieldCheck, Stethoscope } from "lucide-react";
      ...
      <div className="relative z-10 flex h-full items-center justify-center text-center text-white">
        <div className="max-w-2xl px-4">
          <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
            Advanced Colorectal Care by Dr. Erfan
          </h1>
          <p className="mt-4 text-lg md:text-xl max-w-xl mx-auto">
            Combining expertise with cutting-edge laser technology for superior patient outcomes.
          </p>
          <div className="mt-8">
            <AppointmentModal>
              <Button size="lg">
...
function WhyChooseUsSection() {
  return (
    <section className="py-16 sm:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="font-headline text-3xl md:text-4xl font-bold">Why Choose Dr. Erfan?</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Experience compassionate care backed by years of expertise and innovation.
          </p>
        </div>
    ...
    <section className="bg-secondary py-16 sm:py-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            <h2 className="font-headline text-3xl md:text-4xl font-bold">Our Advanced Services</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              We offer state-of-the-art diagnostic and therapeutic services with a focus on minimally invasive laser procedures.
            </p>
            <ul className="mt-6 space-y-4">
              <li className="flex items-start">
                <Stethoscope className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
                <span>
                  <h4 className="font-bold">Laser Treatments</h4>
                  <p className="text-muted-foreground">Painless, effective solutions for various conditions with faster recovery times.</p>
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
                <span>
                  <h4 className="font-bold">Diagnostic Services</h4>
